      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <div className="border-b">
          <TabsList className="w-full justify-start">
            ...
            <TabsTrigger value="trends" className="text-lg px-6">
              <div className="flex items-center gap-2">📈 Trend Analysis</div>
            </TabsTrigger>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <SLAThresholdConfig
                          ...
                          initialThresholds={{
                            warningThreshold:
                              sla.warningThreshold ?? sla.target - 2,
                            criticalThreshold:
                              sla.criticalThreshold ?? sla.target - 5,
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Progress
                          value={
                            sla.measurements.length > 0
                              ? sla.measurements[0].uptimePercent
                              : 0
                          }
                          className="h-2"
                        />
              ...
              {slas.length === 0 && (
                <div className="col-span-full text-center py-10 text-muted-foreground">
                  No SLAs defined yet. Create your first SLA to start tracking
                  uptime.
                </div>
              )}
            </div>
        ...
        <TabsContent value="trends" className="space-y-6">
          ...
          <div className="grid gap-6">
            {slas
              .filter((sla) => sla.measurements.length > 0)
              .map((sla) => (
                <SLATrendGraph
                  key={`trend-${sla.id}`}
              ...
              <Card className="border-dashed">
                <CardContent className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm">
                    No SLA measurement data available yet. Data will appear here
                    once your SLAs start collecting measurements.
                  </p>
                </CardContent>
              </Card>
            )}
