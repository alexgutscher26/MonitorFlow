...
/**
 * A collection of custom SVG icons for use in the application.
 */
export const Icons = {
  /**
   * Discord icon SVG.
   * 
   * - Accepts all standard SVG props via LucideProps for customization.
   * 
   * @param props - Properties for SVG customization, such as `color`, `size`, and `className`.
   * @returns SVG element representing the Discord logo.
   */
   ...
   * 
   * @param props - Properties for SVG customization, such as `color`, `size`, and `className`.
   * @returns SVG element representing a verification badge.
   */
