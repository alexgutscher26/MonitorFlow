...
const communityFeatures = [
  {
    ...
    description:
      "Join discussions, share experiences, and learn from peers in our growing community of DevOps professionals.",
  },
  {
    icon: "📚",
    title: "Knowledge Base",
    description:
      "Access our comprehensive documentation, best practices, and implementation guides.",
  },
  {
    icon: "🎯",
    title: "Feature Requests",
    description:
      "Influence our roadmap by suggesting and voting on new features that matter to you.",
  },
  {
    icon: "🛠️",
    title: "Open Source",
    description:
      "Contribute to our open-source components and help shape the future of monitoring.",
  },
]
